...
const std::array<BuiltinGOL, NGOL> SimulationData::builtinGol = {{
	...
	{ "GOL",  GT_GOL , 0x0080C, 0x0CAC00_rgb, 0x0CAC00_rgb, NGT_GOL,  String("Игра «Жизнь»: рождение 3/жизнь 23") },
	{ "HLIF", GT_HLIF, 0x0480C, 0xFF0000_rgb, 0xFF0000_rgb, NGT_HLIF, String("High Life: B36/S23") },
	{ "ASIM", GT_ASIM, 0x038F0, 0x0000FF_rgb, 0x0000FF_rgb, NGT_ASIM, String("Ассимиляция: B345/S4567") },
	{ "2X2",  GT_2x2 , 0x04826, 0xFFFF00_rgb, 0xFFFF00_rgb, NGT_2x2,  String("2X2: B36/S125") },
	{ "DANI", GT_DANI, 0x1C9D8, 0x00FFFF_rgb, 0x00FFFF_rgb, NGT_DANI, String("День и ночь: B3678/S34678") },
	{ "AMOE", GT_AMOE, 0x0A92A, 0xFF00FF_rgb, 0xFF00FF_rgb, NGT_AMOE, String("Амёба: B357/S1358") },
	{ "MOVE", GT_MOVE, 0x14834, 0xFFFFFF_rgb, 0xFFFFFF_rgb, NGT_MOVE, String("Частицы «Move». Не двигает объекты — это тип жизни: B368/S245") },
	{ "PGOL", GT_PGOL, 0x0A90C, 0xE05010_rgb, 0xE05010_rgb, NGT_PGOL, String("Псевдо-жизнь: B357/S238") },
	{ "DMOE", GT_DMOE, 0x1E9E0, 0x500000_rgb, 0x500000_rgb, NGT_DMOE, String("Диамёба: B35678/S5678") },
	{ "3-4",  GT_34  , 0x01818, 0x500050_rgb, 0x500050_rgb, NGT_34,   String("3-4: B34/S34") },
	{ "LLIF", GT_LLIF, 0x03820, 0x505050_rgb, 0x505050_rgb, NGT_LLIF, String("Длинная жизнь: B345/S5") },
	{ "STAN", GT_STAN, 0x1C9EC, 0x5000FF_rgb, 0x5000FF_rgb, NGT_STAN, String("Пятна: B3678/S235678") },
	{ "SEED", GT_SEED, 0x00400, 0xFBEC7D_rgb, 0xFBEC7D_rgb, NGT_SEED, String("Семена: B2/S") },
	{ "MAZE", GT_MAZE, 0x0083E, 0xA8E4A0_rgb, 0xA8E4A0_rgb, NGT_MAZE, String("Лабиринт: B3/S12345") },
	{ "COAG", GT_COAG, 0x189EC, 0x9ACD32_rgb, 0x9ACD32_rgb, NGT_COAG, String("Коагуляция: B378/S235678") },
	{ "WALL", GT_WALL, 0x1F03C, 0x0047AB_rgb, 0x0047AB_rgb, NGT_WALL, String("Огороженные города: B45678/S2345") },
	{ "GNAR", GT_GNAR, 0x00202, 0xE5B73B_rgb, 0xE5B73B_rgb, NGT_GNAR, String("Gnarl: B1/S1") },
	{ "REPL", GT_REPL, 0x0AAAA, 0x259588_rgb, 0x259588_rgb, NGT_REPL, String("Репликатор: B1357/S1357") },
	{ "MYST", GT_MYST, 0x139E1, 0x0C3C00_rgb, 0x0C3C00_rgb, NGT_MYST, String("Мистерия: B3458/S05678") },
	{ "LOTE", GT_LOTE, 0x48938, 0xFF0000_rgb, 0xFFFF00_rgb, NGT_LOTE, String("Жизнь на краю: B37/S3458/4") },
	{ "FRG2", GT_FRG2, 0x20816, 0x006432_rgb, 0x00FF5A_rgb, NGT_FRG2, String("Как правило Frogs: B3/S124/3") },
	{ "STAR", GT_STAR, 0x98478, 0x000040_rgb, 0x0000E6_rgb, NGT_STAR, String("Как правило Star Wars: B278/S3456/6") },
	{ "FROG", GT_FROG, 0x21806, 0x006400_rgb, 0x00FF00_rgb, NGT_FROG, String("Лягушки: B34/S12/3") },
...
static std::vector<wall_type> LoadWalls()
{
	...
	std::vector<wall_type>{
		{0x808080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("ERASE"),           "DEFAULT_WL_ERASE",  String("Стирает стены.")},
		{0xC0C0C0_rgb, 0x101010_rgb, 0, Renderer::WallIcon, String("ПРОВОДНАЯ СТЕНА"), "DEFAULT_WL_CNDTW",  String("Блокирует всё. Проводит электричество.")},
		{0x808080_rgb, 0x808080_rgb, 0, Renderer::WallIcon, String("EWALL"),           "DEFAULT_WL_EWALL",  String("Э-стена. Становится прозрачной при подключении электричества.")},
		{0xFF8080_rgb, 0xFF2008_rgb, 1, Renderer::WallIcon, String("ДЕТЕКТОР"),        "DEFAULT_WL_DTECT",  String("Детектор. Генерирует электричество, когда внутри есть частица.")},
		{0x808080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("ПОТОК"),      "DEFAULT_WL_STRM",   String("Поток. Создает линию, следующую за движением воздуха.")},
		{0x8080FF_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ВЕНТИЛЯТОР"),             "DEFAULT_WL_FAN",    String("Вентилятор. Ускоряет воздух. Линейный инструмент задаёт направление и силу.")},
		{0xC0C0C0_rgb, 0x101010_rgb, 2, Renderer::WallIcon, String("ЖИДКАЯ СТЕНА"),     "DEFAULT_WL_LIQD",   String("Пропускает жидкости, блокирует остальные частицы. Проводит электричество.")},
		{0x808080_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ПОГЛОТ. СТЕНА"),     "DEFAULT_WL_ABSRB",  String("Поглощает частицы, но пропускает потоки воздуха.")},
		{0x808080_rgb, 0x000000_rgb, 3, Renderer::WallIcon, String("СТЕНА"),            "DEFAULT_WL_WALL",   String("Обычная стена, блокирует всё.")},
		{0x3C3C3C_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ВОЗДУШНАЯ СТЕНА"),    "DEFAULT_WL_AIR",    String("Пропускает воздух, но блокирует все частицы.")},
		{0x575757_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ПЫЛЬНАЯ СТЕНА"),     "DEFAULT_WL_POWDR",  String("Пропускает пыль, блокирует остальные частицы.")},
		{0xFFFF22_rgb, 0x101010_rgb, 2, Renderer::WallIcon, String("ПРОВОДНИК"),       "DEFAULT_WL_CNDTR",  String("Проводник. Пропускает все частицы и проводит электричество.")},
		{0x242424_rgb, 0x101010_rgb, 0, Renderer::WallIcon, String("EHOLE"),           "DEFAULT_WL_EHOLE",  String("Э-дыра. Поглощает частицы и выбрасывает их при подаче питания.")},
		{0x579777_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("ГАЗОВАЯ СТЕНА"),        "DEFAULT_WL_GAS",    String("Пропускает газы, блокирует остальные частицы.")},
		{0xFFEE00_rgb, 0xAA9900_rgb, 4, Renderer::WallIcon, String("ГРАВИТ. СТЕНА"),    "DEFAULT_WL_GRVTY",  String("Гравитационная стена. Ньютоновская гравитация не действует внутри области.")},
		{0xFFAA00_rgb, 0xAA5500_rgb, 4, Renderer::WallIcon, String("ЭНЕРГ. СТЕНА"),     "DEFAULT_WL_ENRGY",  String("Пропускает энергетические частицы, блокирует остальные.")},
		{0xDCDCDC_rgb, 0x000000_rgb, 1, Renderer::WallIcon, String("БЕЗВОЗД. СТЕНА"),   "DEFAULT_WL_NOAIR",  String("Пропускает все частицы, но блокирует воздух.")},
		{0x808080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("СТЕРЕТЬ ВСЁ"),        "DEFAULT_WL_ERASEA", String("Стирает стены, частицы и таблички.")},
		{0x800080_rgb, 0x000000_rgb, 0, Renderer::WallIcon, String("СТАЗИС"),     "DEFAULT_WL_STASIS", String("Замораживает частицы внутри стены до подачи питания.")},
	};
}
...
static std::vector<menu_section> LoadMenus()
{
	...
	std::vector<menu_section>{
		{0xE041, String("Стены"), 0, 1},
		{0xE042, String("Электроника"), 0, 1},
		{0xE056, String("Питаемые материалы"), 0, 1},
		{0xE019, String("Датчики"), 0, 1},
		{0xE062, String("Силы"), 0, 1},
		{0xE043, String("Взрывчатка"), 0, 1},
		{0xE045, String("Газы"), 0, 1},
		{0xE044, String("Жидкости"), 0, 1},
		{0xE050, String("Пыль"), 0, 1},
		{0xE051, String("Твёрдые"), 0, 1},
		{0xE046, String("Радиоактивные"), 0, 1},
		{0xE04C, String("Особые"), 0, 1},
		{0xE052, String("Игра «Жизнь»"), 0, 1},
		{0xE057, String("Инструменты"), 0, 1},
		{0xE067, String("Избранное"), 0, 1},
		{0xE064, String("Декорация"), 0, 1},
	};
}
...
String SimulationData::BasicParticleInfo(Particle const &sample_part) const
{
	...
	{
		sampleInfo << "Расплавл. " << ElementResolve(ctype, -1);
	}
	else if ((type == PT_PIPE || type == PT_PPIP) && IsElement(ctype))
	{
		if (ctype == PT_LAVA && IsElement(storedCtype))
		{
			sampleInfo << ElementResolve(type, -1) << " с расплавл. " << ElementResolve(storedCtype, -1);
		}
		else
		{
			sampleInfo << ElementResolve(type, -1) << " с " << ElementResolve(ctype, storedCtype);
		}
	}
	else
	{
