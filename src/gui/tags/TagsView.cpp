...
{
	closeButton = new ui::Button(ui::Point(0, Size.Y-16), ui::Point(195, 16), "Закрыть");
	...
	tagInput = new ui::Textbox(ui::Point(8, Size.Y-40), ui::Point(Size.X-60, 16), "", "[новый тег]");
	...
	addButton = new ui::Button(ui::Point(tagInput->Position.X+tagInput->Size.X+4, tagInput->Position.Y), ui::Point(40, 16), "Добавить");
	...
	title = new ui::Label(ui::Point(5, 5), ui::Point(185, 28), "Теги:    \bgТеги нужны только \nдля улучшения поиска");
...
void TagsView::addTag()
{
	...
	{
		new ErrorMessage("Тег слишком короткий", "Минимум 4 символа");
		return;
	}
