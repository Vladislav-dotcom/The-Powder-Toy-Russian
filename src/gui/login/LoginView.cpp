...
LoginView::LoginView():
	...
	loginButton(new ui::Button(ui::Point(200-100, 87-17), ui::Point(100, 17), "Войти")),
	cancelButton(new ui::Button(ui::Point(0, 87-17), ui::Point(101, 17), "Выйти")),
	titleLabel(new ui::Label(ui::Point(4, 5), ui::Point(200-16, 16), "Вход на сервер")),
	infoLabel(new ui::RichLabel(ui::Point(6, 67), ui::Point(200-12, 16), "")),
	usernameField(new ui::Textbox(ui::Point(8, 25), ui::Point(200-16, 17), "", "[имя]")),
	passwordField(new ui::Textbox(ui::Point(8, 46), ui::Point(200-16, 17), "", "[пароль]"))
{
...
void LoginView::NotifyStatusChanged(LoginModel * sender)
{
	...
	{
		statusText = String::Build("Нет аккаунта? {a:", SERVER, "/Register.html", "|\btЗарегистрироваться\x0E}.");
	}
